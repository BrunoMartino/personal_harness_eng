...
**Ask using AskQuestion or natural conversation**:
...
**If critical sections are missing, ask the user**:
...
After mandatory sections are covered, **offer optional sections**:
...
If user has Confluence Assistant skill available, ask:
...
- **Ask clarifying questions** - Don't guess missing information
